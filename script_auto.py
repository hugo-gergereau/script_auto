...
while countdown > 0:
    print('Démarrage dans', countdown, 'secondes')
...
def speedest():
    ...
    def shell():
        ...
        if not args.mini:
            ...
            try:
                speedtest.get_servers(
                    servers=args.server, exclude=args.exclude)
...
while fermeture > 0:
    ...
    print("femeture dans  ", fermeture, "secondes")
    print("rester appuyé sur espace pour quiter ")
    time.sleep(1)
    fermeture = fermeture - 1
    if keyboard.is_pressed(" "):
        print('vous avez press espace')
